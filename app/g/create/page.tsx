  ...
  const { mutate: createCommunity, isLoading } = useMutation({
    ...
    onError: (err) => {
      ...
      toast({
        ...
        description: "Could not create subgroup.",
        variant: "destructive",
      });
    },
    onSuccess: (data) => {
      ...
      <div className="relative bg-white w-full h-fit p-4 rounded-lg space-y-6">
        ...
        <div>
          ...
          <p className="text-xs pb-2">
            Group names including capitalization cannot be changed. Group name can not contain any spaces.
          </p>
